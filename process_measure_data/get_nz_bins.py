...
def parse_arguments():
    ...
    parser.add_argument('--ds_m_inp', default=2, type=int,
    ...
    parser.add_argument('--bins', default=[1, 2, 3, 4, 5, 6], type=list, help='Bins in the catalogs')
...
if __name__ == "__main__":
    ...
    save_dir = '/global/project/projectdirs/des/y3-bias/MICE_all_data/v2/maglim/'
