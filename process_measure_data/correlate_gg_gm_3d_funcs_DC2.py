...
def parse_arguments():
    ...
    parser.add_argument('--ds_g', default=8, type=int, help='Ratio by which to downsample the galaxy catalog')
...
if __name__ == "__main__":
    ...
    load_dir = '/global/project/projectdirs/m1727/shivamp_lsst/data_set/dc2_v1.0/process_cats/'
    ...
    #     njk_radec) + '_njkz_' + str(njk_z) + '_ds_' + str(ds_m_inp) + '.fits'
    load_filename_galaxy = 'galaxy_ra_dec_r_z_bin_jk_cosmoDC2_v1.0_njkradec_' + str(
        njk_radec) + '_njkz_' + str(njk_z) + '_ds_' + str(ds_g) + '.fits'
    load_filename_galaxy_randoms = 'randoms_galaxy_ra_dec_r_z_bin_jk_cosmoDC2_v1.0_njkradec_' + str(
        njk_radec) + '_njkz_' + str(njk_z) + '_ds_' + str(ds_g) + '.fits'


    save_dir = '/global/project/projectdirs/m1727/shivamp_lsst/data_set/dc2_v1.0/measurements/'
    ...
    plot_save_name_gg_gm_mm = 'gg_3dcorr_r_' + str(minrad) + '_' + str(maxrad) + '_nr_' + str(nrad) + '_zbin_' + str(
        binval) + '_jk_' + str(do_jk) + '_njkradec_' + str(njk_radec) + '_njkz_' + str(njk_z) + '_dsg_' + str(
        ds_g) + '_dsm_' + str(ds_m_inp*ds_m) + '.pdf'
    plot_save_name_gg_gm_mm_ratio = 'gg_gm_mm_ratio_3dcorr_r_' + str(minrad) + '_' + str(maxrad) + '_nr_' + str(
        ...
        njk_z) + '_dsg_' + str(ds_g) + '_dsm_' + str(ds_m_inp*ds_m) + '.pdf'
