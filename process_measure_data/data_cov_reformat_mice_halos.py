...
for jm in range(len(massbin_max)):
    ...
    save_dir_gg_gm = '/global/project/projectdirs/des/shivamp/actxdes/data_set/mice_sims/measurements/halo_' + str(
        lmhalo_min) + '_' + str(lmhalo_max) + '/'
    ...
    for binval in bins_all:
        ...
        filenames_mm.append(save_dir + save_filename_mm)
    ...
    filename_save = save_dir_gg_gm + 'gg_gm_lmhalo_'+ str(lmhalo_min) + '_' + str(
        lmhalo_max) +'_datavec_3dcorr_r_' + str(minrad) + '_' + str(maxrad) + '_nr_' + str(
    ...
    filename_save = save_dir_gg_gm + 'gg_mm__gm_mm_lmhalo_'+ str(lmhalo_min) + '_' + str(
        lmhalo_max) +'_datavec_3dcorr_r_' + str(minrad) + '_' + str(maxrad) + '_nr_' + str(
        nrad) + '_zbin_1_2_3_4_5_jk_True_njk_' + str(njk) + '_v2_fullsample.pk'
    pk.dump(results_dict, open(filename_save, 'wb'), protocol=2)
    ...
    if diag_plots:
        ...
        fig.savefig(save_dir_gg_gm + 'gg_gm_3d_corr_mat_lin.png')
        ...
        fig.savefig(save_dir_gg_gm + 'gg_mm__gm_mm_3d_corr_mat_lin_v2.png')
        ...
        plt.savefig(save_dir_gg_gm + 'xi_gg_gm_allbins_comp_v2_fullsample.png')
        plt.close()
        ...
        plt.savefig(save_dir_gg_gm + 'xi_gg_mm__gm_mm_allbins_comp_v2_fullsample.png')
        plt.close()
        ...
        ax.set_title('Halo mass bin : ' + str(lmhalo_min) + '-' + str(lmhalo_max), size=14)
        ax.set_xlabel(r'R  (Mpc/h)', size=18)
        plt.tight_layout()

        plt.savefig(save_dir_gg_gm + 'xi_gg_mm__gm_mm_lmhalo_'+ str(lmhalo_min) + '_' + str(lmhalo_max) +'_allbins_comp_onepanel_v2_fullsample.png')
        plt.close()
