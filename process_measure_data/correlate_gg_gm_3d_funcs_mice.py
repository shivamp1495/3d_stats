...
def parse_arguments():
    ...
    parser.add_argument('--njk_radec', default=300, type=int, help='Number of jack-knife patches in ra-dec dimensions')
    ...
    parser.add_argument('--ds_m_inp', default=1.67, type=float, help='Ratio by which matter catalog was initially downsampled')
...
if __name__ == "__main__":
    ...
    load_filename_galaxy = 'galaxy_ra_dec_r_z_bin_jk_mice_des_run_redmapper_v6.4.16_redmagic_njkradec_' + str(njk_radec) + '_njkz_' + str(njk_z) + '_v2.fits'
    load_filename_galaxy_randoms = 'randoms_galaxy_ra_dec_r_z_bin_jk_mice_des_run_redmapper_v6.4.16_redmagic_redmagic_njkradec_' + str(njk_radec) + '_njkz_' + str(njk_z) + '_v2.fits'
    ...
    plot_save_name_gg_gm_mm = 'gg_gm_mm_3dcorr_r_' + str(minrad) + '_' + str(maxrad) + '_nr_' + str(nrad) + '_zbin_' + str(
        binval) + '_jk_' + str(do_jk) + '_njkradec_' + str(njk_radec) + '_njkz_' + str(njk_z) + '_dsg_' + str(
        ds_g) + '_dsm_' + str(ds_m_inp*ds_m) + '_v2.pdf'
    plot_save_name_gg_gm_mm_ratio = 'gg_gm_mm_ratio_3dcorr_r_' + str(minrad) + '_' + str(maxrad) + '_nr_' + str(
        ...
        njk_z) + '_dsg_' + str(ds_g) + '_dsm_' + str(ds_m_inp*ds_m) + '_v2.pdf'
